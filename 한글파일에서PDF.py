...
#파일의 경로를 지정해줍니다.
getPath = "C:\\Users\\WSuser\\Desktop\\WS공유\\노가다작업\\가을학기\\LMS결과보고(20231204)가을\\1-5~7 우송중"
savePath = "C:\\Users\\WSuser\\Desktop\\WS공유\\노가다작업\\가을학기\\pdf저장"


main_folder = "C:\\Users\\WSuser\\Desktop\\WS공유\\노가다작업\\가을학기\\LMS결과보고(20231204)가을\\1-48~51 대전동화중" # 검색 폴더 위치
...
for filePath in folderList:
    ...
    files = [f for f in os.listdir(filePath) if re.match('.*[.]hwp', f)]
    ...
    for file in files:
        ...
        hwp.Open(os.path.join(filePath, file))
